# The State Space Model (center = TRUE)
...
$`\boldsymbol{\Lambda}`$ a denotes a matrix of factor loadings, and
...
$`\boldsymbol{\mu}_{\boldsymbol{\eta}}`$, $`\boldsymbol{\beta}`$, and
...
time $`t`$ and individual $`i`$.
$`\boldsymbol{\mu}_{\boldsymbol{\eta}}`$ denotes a vector of set-points,
$`\boldsymbol{\beta}`$ a matrix of autoregression and cross regression
coefficients, and $`\boldsymbol{\Psi}`$ the covariance matrix of
$`\boldsymbol{\zeta}_{i, t}`$.
...
![](fig-vignettes-example-center-true-no-error-ssm-1.png)![](fig-vignettes-example-center-true-no-error-ssm-2.png)![](fig-vignettes-example-center-true-no-error-ssm-3.png)
...
![](fig-vignettes-example-center-true-error-ssm-1.png)![](fig-vignettes-example-center-true-error-ssm-2.png)![](fig-vignettes-example-center-true-error-ssm-3.png)
...
The intercept vector $`\boldsymbol{\mu}_{\boldsymbol{\eta}}`$ is
