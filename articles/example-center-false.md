# The State Space Model (center = FALSE)
...
![](fig-vignettes-example-center-false-no-error-ssm-1.png)![](fig-vignettes-example-center-false-no-error-ssm-2.png)![](fig-vignettes-example-center-false-no-error-ssm-3.png)
...
![](fig-vignettes-example-center-false-error-ssm-1.png)![](fig-vignettes-example-center-false-error-ssm-2.png)![](fig-vignettes-example-center-false-error-ssm-3.png)
...
The intercept vector $`\boldsymbol{\alpha}`$ is initialized with
starting values.
...
#>      0.0013      0.0001      0.4929      0.9489      0.9323      0.2921 
